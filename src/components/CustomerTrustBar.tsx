        ...
        <Card className={cn("rounded-[2rem] border-none shadow-sm bg-white/90 dark:bg-zinc-900/80 backdrop-blur-xl p-4 md:p-6", className)}>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 dark:text-zinc-400">Atendendo beleza e bem-estar desde {tenant.createdAt ? new Date(tenant.createdAt).getFullYear() : "2014"}.</p>
                </div>
